...
def add_history_from_address(address):
    ...
    return make_response(jsonify(build_error("Not implemented add_history_from_address")), 200)
...
def add_history_to_address(address):
    ...
    return make_response(jsonify(build_error("Not implemented add_history_to_address")), 200)
